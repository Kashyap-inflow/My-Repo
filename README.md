This is a "Vulnerable" Web Application developed by Cyber Security and Privacy Foundation(www.cysecurity.org). This app is intended for the Java Programmers and other peopl who wish to learn about Web application vulnerabilities and write secure code.
